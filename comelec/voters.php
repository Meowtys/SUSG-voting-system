...
<body class="bg-gray-50">
    ...
    <script>
        ...
        openModalBtn.addEventListener("click", () => {
            document.getElementById('studentForm').action = '../technical/comelec/create_student.php';
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('studentForm').action = '../technical/comelec/edit_student.php';
