        ...
        <div class="container">
            ...
            <div class="content-section hidden">
                ...
                <form id="candidateForm">
                    ...
                    <label for="qpa">Quality Point Average (QPA):</label>
                    <input type="number" id="qpa" name="qpa" step="0.01" placeholder="Enter your QPA" required>
    
                    <label for="units">Number of Units Enrolled:</label>
                    <input type="number" id="units" name="units" placeholder="Enter your current number of units" required>
                </form>
            </div>
