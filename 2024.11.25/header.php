...
<head>
    ...
    <style>
        ...
        .header-logo-link:active {
            transform: scale(0.95); /* Adds a slight press effect when clicked */
        }
    </style>
</head>
<body>
    <!-- Header -->
    <header class="header">
        <a href="homepage.php" class="header-logo-link">
    ...
    <nav class="header-menu" id="header-side-menu">
        ...
        <ul>
            ...
            <li><a href="logout.php">Logout</a></li> <!-- Call logout function here -->
        </ul>
    </nav>
