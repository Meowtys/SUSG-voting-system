...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM Students WHERE username = '$inputUsername' AND is_admin = 1";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($inputPassword === $user['password']) { // Replace with password_verify if passwords are hashed
            ...
            // Redirect to admin live results page
            header("Location: Admin/admin-liveresults.php");
            exit();
        } else {
...
<head>
    ...
    <title>SUSG Election System - Login as Comelec</title>
...
<body>
    ...
    <main class="main">
        <div class="login-page-box">
            ...
            <form id="loginForm" method="POST" action="loginascomelec.php">
