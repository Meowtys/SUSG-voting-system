...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['studentFormId'], $_POST['studentId'], $_POST['studentName'], $_POST['college'], $_POST['hasVoted'])) {
        ...
        $stmt = $pdo->prepare("
            UPDATE students 
            SET student_id = ?, student_name = ?, college_id = ?, has_voted = ?
            WHERE student_id = ?
        ");
        if ($stmt->execute([$studentId, $studentName, $college, $hasVoted, $studentFormId])) {
